  ...
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      <ul class="container" :style="containerStyle">
        <li>
          <img :src="sliders[sliders.length - 1].image" alt="">
        </li>
      ...
      <ul class="direction">
        <li class="left" @click="move(1900, 1, speed)">
        ...
        <li class="right" @click="move(1900, -1, speed)">
...
export default {
  ...
  methods: {
    getBannerImages () {
      ...
      api.getBannerImgAPI(params).then((res) => {
    ...
    move (offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset / 1900 : this.currentIndex -= offset / 1900
    ...
    animate (des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -3000) this.distance = -1900
          if (des > -1900) this.distance = -3000
        }
      }, 20)
    },
    jump (index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1
      const offset = Math.abs(index - this.currentIndex) * 1900
